...
show_status() {
  ...
  if [[ -n "${RUNTIME_MANIFEST_VERSION:-}" ]]; then
    ...
    echo "  Cosmos: LGPL-3.0+   Runtime: Wine LGPL-2.1+ | DXMT ${DXMT_VERSION} (MIT≤0.80, LGPL above)"
    echo "  COSMOS_ALLOW_LGPL=${COSMOS_ALLOW_LGPL:-1}   Notices: LICENSE, runtime/NOTICE.md"
  fi
  echo ""
